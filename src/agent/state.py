...
class ProductEnvironmentState(TypedDict):
    ...
    descriptive_prompt: Optional[str]   # Este campo guarda el prompt detallado que se usará en el caso de seleccionar el modelo de generación potente mediatne API
